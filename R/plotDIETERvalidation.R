...
#' REMIND-DIETER plot capacity factors
#'
#' Plot capacity factors of REMIND and DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
#' @importFrom lusweave swlatex swfigure
#' @importFrom quitte read.gdx revalue.levels
#' @export
...
#' REMIND-DIETER plot capacities
#'
#' Plot capacities of REMIND and DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot generation
#'
#' Plot generation of REMIND and DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot added capacities
#'
#' Plot added capacities of REMIND and DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot LCOEs
#'
#' Plot LCOEs of REMIND and DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot secondary electricity price
#'
#' Plot secondary electriciy price of REMIND over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot peak demand shadow price
#'
#' Plot peak demand shadow price of REMIND over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot residual load duration curves (RLDCs)
#'
#' Plot RLDCs of DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot price duration curves
#'
#' Plot price duration curves of DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
#' REMIND-DIETER plot (inverse) screening curves
#'
#' Plot standard and inverse screening curves of DIETER over iterations.
#'
#' @author Adrian Odenweller
#' @import dplyr
#' @import ggplot2
...
DIETERplotInverseScreeningCurve <- function() {
    ...
    for (i in unique(out.dieter$iteration)) {
        ...
        p <- ggplot() +
            geom_line(data = plot.dieter, aes(x = hour.sorted, y = screening, colour = technology, linetype = hour.running), size = 1) +
    ...
    for (i in unique(out.dieter$iteration)) {
        ...
        p <- ggplot() +
            geom_line(data = plot.dieter, aes(x = hour.sorted, y = inv.screening, colour = technology, linetype = hour.running), size = 1) +
            scale_colour_manual(name = "Technology", values = color.mapping) +
            scale_linetype_manual(name = "Running", values = c(Yes = "solid", No = "dotted")) +
            scale_x_continuous(limits = c(0, 8760)) +
